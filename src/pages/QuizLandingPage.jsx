...
export default function QuizLandingPage() {
  ...
  return (
    <div className="bg-parchment text-ink">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden pt-32 pb-24 px-6 bg-parchment">
        <div className="absolute top-0 left-0 right-0 h-1 color-stripe z-20" />
        <div className="absolute top-[5%] right-[5%] w-96 h-96 rounded-full bg-morning/20 blur-3xl pointer-events-none" />
        <div className="absolute bottom-[10%] left-[5%] w-80 h-80 rounded-full bg-sunrise/15 blur-3xl pointer-events-none" />
        <div className="absolute top-[40%] left-[40%] w-64 h-64 rounded-full bg-growth/10 blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <Reveal delay={0.1}>
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.08] tracking-tight mb-6 text-ink">
              What should you<br />
              <span className="gradient-text-animated">build first?</span>
            </h1>
          </Reveal>

          <Reveal delay={0.18}>
            <p className="text-lg leading-relaxed max-w-xl mx-auto mb-10 text-ink/60">
          ...
          <Reveal delay={0.26}>
            ...
            <p className="text-sm mt-4 text-ink/35">Free · 10 minutes · no account needed</p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          <Reveal>
            <p className="text-growth text-[11px] font-bold uppercase tracking-[0.25em] text-center mb-3">What to expect</p>
              ...
              <Reveal key={title} delay={i * 0.08}>
                <div className="flex gap-5 items-start p-5 rounded-2xl border border-ink/6 bg-parchment hover:shadow-md transition-all duration-200">
                  <div className="shrink-0 flex items-center gap-2">
                    <div className={`w-0.5 self-stretch ${accent} rounded-full`} />
                    <div
      ...
      <section className="py-20 px-6 bg-parchment">
        <Reveal>
          <div className="max-w-xl mx-auto rounded-3xl p-10 text-center relative overflow-hidden bg-white border border-ink/8 shadow-sm">
            <div className="absolute top-0 left-0 right-0 h-1 color-stripe" />
            <div className="w-12 h-12 rounded-full bg-sunrise/20 flex items-center justify-center text-xl mx-auto mb-5">💡</div>
            ...
            <p className="text-sm leading-relaxed mb-8 max-w-sm mx-auto text-ink/50">
