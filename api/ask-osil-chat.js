...
- **Facebook Ad Strategy Package** — Full Meta ad campaign setup + monitoring. $600 flat for the launch package (30-min strategy session, campaign setup, targeting, ad copy, custom graphic in 3 sizes, promotional video, monitoring, one round of revisions). Does NOT include ad spend (paid directly to Meta) or website/landing page creation (see Website Build for that). Start by filling out the intake at https://osilpistole.com/ad-strategy — Osil reviews and replies within 24 hours. Great fit for coaches, consultants, and small businesses ready to spend at least ~$500/month on Meta ads.
